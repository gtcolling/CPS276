...
<html lang="en">
    ...
    <div class="container">
	<form method="post" action="#" id="addContactInfo">
    ...
    <div class="form-group">
        ...
        <input type="date" name="birthDate2" id="birthDate2" class="form-control"
            value="<?echo isset($_POST['birthDate2']) ? $_POST['birthDate2'] : ''; ?>">
    </div>

    <div class="form-group col-md-12">Please check all contact types you would like (optional):
    </div>
    <div class="form-horizontal'">
        <input type="checkbox" class="checkbox inline" id="newsLetter" name="newsLetter"
        <?if(isset($_REQUEST['submit']) && isset($_REQUEST['newsLetter'])){?>
                checked
        <?}?>>
        <label class="form-check-label" for="newsLetter">Newsletter</label>

        <input type="checkbox" class="checkbox inline" id="emailUpdate" name="emailUpdate"
        <?if(isset($_REQUEST['submit']) && isset($_REQUEST['emailUpdate'])){?>
                checked
        <?}?>>
        ...
        <?if(isset($_REQUEST['submit']) && isset($_REQUEST['textUpdate'])){?>
                checked
        <?}?>>
    ...
    <br>
    <div>
        <button type="submit" name="submit" class="btn btn-primary" form_id="addContactInfo">Submit</button>
	</div>
	</form>
	</body>
</html>
